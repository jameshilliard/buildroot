...
FREERDP_VERSION = 3.8.0
FREERDP_SOURCE = freerdp-$(FREERDP_VERSION).tar.xz
FREERDP_SITE = https://pub.freerdp.com/releases
FREERDP_DEPENDENCIES = host-pkgconf libglib2 openssl zlib
FREERDP_LICENSE = Apache-2.0
FREERDP_LICENSE_FILES = LICENSE
FREERDP_SUPPORTS_IN_SOURCE_BUILD = NO

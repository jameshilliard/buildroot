...
PYTHON_NUMPY_SITE = https://files.pythonhosted.org/packages/25/ca/1166b75c21abd1da445b97bf1fa2f14f423c6cfb4fc7c4ef31dccf9f6a94
...
PYTHON_NUMPY_SETUP_TYPE = meson-python
...
PYTHON_NUMPY_MESON_OPTS += -Dlapack=lapack
else
PYTHON_NUMPY_MESON_OPTS += -Dlapack=""
endif

ifeq ($(BR2_PACKAGE_OPENBLAS),y)
PYTHON_NUMPY_DEPENDENCIES += openblas
PYTHON_NUMPY_MESON_OPTS += -Dblas=openblas
else
PYTHON_NUMPY_MESON_OPTS += -Dblas=""
endif
...
# in-tree code.
HOST_PYTHON_NUMPY_MESON_OPTS = -Dblas="" -Dlapack=""
